...
$(document).ready(function(){
  ...
  if (getParameter("page") == "addBooking") {
    ...
    function hasBookingID(){
      ...
      $.get('http://localhost/htdocs/Curriculumvitae/Backend/includes/customerJSON.php?id='+bookingID, function(data){
  ...
  $.get("http://localhost/htdocs/Curriculumvitae/Backend/includes/JSON.php", function(data, status){
