...
$tietokanta='lainaus'; //tietokannan nimi
$dbUser='lainaus'; //MySQL-palvelimella määritelty tietokantakohtainen käyttäjätunnus
$dbPassword='lainaus'; //MySQL-palvelimella määritelty tietokantakohtaisen tunnuksen salasana
