...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <h4>Profiilikuva</h4>
        <?php
            if(!empty($rivi['profiilikuva'])){
            ?><img class="img-fluid" src="images/profiilikuvat/<?php echo $rivi['profiilikuva']?>" alt="Profiilikuva">
            <?php
            }
            
        ?>
        <form action="talletaProfiilikuva.php" method="post" enctype="multipart/form-data">
            <input type="hidden" name="profiilikuva" value="<?php echo $rivi['profiilikuva']?>">
            <p>Valitse profiilikuva:</p>
            <input type="file" name="tiedosto"><button type="submit" class="btn btn-primary">Päivitä</button>
        </form>
    </div>
    <!--Salasanalomake-->
    <div class="col-sm-6">
